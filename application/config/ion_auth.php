 ...
 */
$config['site_title']                 = "SOCLE";       // Site Title, example.com
$config['admin_email']                = "zacharie.moulin-rnf@espaces-naturels.fr"; // Admin Email, admin@example.com
...
$config['user_expire']                = 60*60*48;               // How long to remember the user (seconds). Set to zero for no expiration
