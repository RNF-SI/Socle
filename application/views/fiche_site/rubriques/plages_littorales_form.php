...
<p>Quelles morphologies littorales de plage (sables-galets-vases) sont-elles observables
...
<?php
  ...
  echo liste_complement($question, set_value('complements', isset($ep->complements[$question]) ? $ep->complements[$question]->elements : ''),
    'Autres éléments descriptifs des morphologies de plage observables sur votre territoire, non mentionnés dans la liste ci-dessus. Nommer et décrire si besoin&nbsp;?');
